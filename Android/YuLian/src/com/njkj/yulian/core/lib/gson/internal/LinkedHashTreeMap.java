...
package com.njkj.yulian.core.lib.gson.internal;
...
/**
 * A com.njkj.yulian.ui.activity.map of comparable keys to values. Unlike {@code TreeMap}, this class uses
...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  /**
   * Create a natural order, empty tree com.njkj.yulian.ui.activity.map whose keys must be mutually
  ...
  /**
   * Create a tree com.njkj.yulian.ui.activity.map ordered by {@code comparator}. This com.njkj.yulian.ui.activity.map's keys may only
  ...
  /**
   * Returns this com.njkj.yulian.ui.activity.map's entry that has the same key and value as {@code
   * entry}, or null if this com.njkj.yulian.ui.activity.map has no such entry.
   *
   * <p>This method uses the comparator for key equality rather than {@code
   * equals}. If this com.njkj.yulian.ui.activity.map's comparator isn't consistent with equals (such as
   ...
   * necessary.
   *
   * @param unlink true to also unlink this node from the iteration linked swipe_target.
   */
  ...
  static class AvlIterator<K, V> {
    /** This stack is a singly linked swipe_target, linked by the 'parent' field. */
