 ...
 */
package com.njkj.yulian.core.lib.volley.toolbox;
...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (request != null) {
            // If it is, add this request to the swipe_target of listeners.
    ...
    protected void onGetImageSuccess(String cacheKey, Bitmap response) {
        ...
        // remove the request from the swipe_target of in-flight requests.
    ...
    protected void onGetImageError(String cacheKey, VolleyError error) {
        ...
        // Remove this request from the swipe_target of in-flight requests.
        BatchedImageRequest request = mInFlightRequests.remove(cacheKey);
    ...
    /**
     * Wrapper class used to com.njkj.yulian.ui.activity.map a Request to the set of active ImageContainer objects that are
    ...
    private class BatchedImageRequest {
        ...
        /**
         * Adds another ImageContainer to the swipe_target of those interested in the results of
         * the request.
         */
         ...
         * left listening.
         * @param container The container to remove from the swipe_target
