package com.njkj.yulian.ui.gui.fab;
 ...
 * according to <a
 * href="http://www.google.com/design/spec/patterns/promoted-actions.html"
 * >Promoted Actions</a> pattern.
 * <p/>
 * Like an {@link ImageView} this widget require {@code android:src} attribute.
 * According to official documentation this drawable should be not more than
 * {@code 24dp}.
 * <p/>
				...
				if (shadow instanceof GradientDrawable) {
					if (mShadow) {
						((GradientDrawable) shadow.mutate())
								.setGradientRadius(getShadowRadius(shadow,
										circle));
					} else {
						shadow.setAlpha(0);
					}
