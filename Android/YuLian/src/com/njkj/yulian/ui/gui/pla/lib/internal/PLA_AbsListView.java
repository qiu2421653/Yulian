...
package com.njkj.yulian.ui.gui.pla.lib.internal;
...
/**
 * Base class that can be used to implement virtualized lists of items. A swipe_target
 * does not have a spatial definition here. For instance, subclases of this
 * class can display the content of the swipe_target in a grid, in a carousel, as stack,
 * etc.
 * 
...
public abstract class PLA_AbsListView extends PLA_AdapterView<ListAdapter>
	...
	/**
	 * The swipe_target will automatically scroll to the bottom when a data set change
	...
	/**
	 * The swipe_target will automatically scroll to the bottom, no matter what items
	...
	/**
	 * Indicates whether the swipe_target selector should be drawn on top of the
	 * children or behind
	 */
	...
	/**
	 * Handles scrolling between positions within the swipe_target.
	 */
	...
	/**
	 * Indicates whether the swipe_target is stacked from the bottom edge or the top
	 * edge.
	 */
	boolean mStackFromBottom;

	/**
	 * When set to true, the swipe_target automatically discards the children's bitmap
	...
	/**
	 * This view is in transcript mode -- it shows the bottom of the swipe_target when
	 * the data changes
	 */
	private int mTranscriptMode;

	/**
	 * Indicates that this swipe_target is always drawn on top of a solid, single-color,
	 * opaque background
	 */
	...
	/**
	 * Interface definition for a callback to be invoked when the swipe_target or grid
	 * has been scrolled.
	 */
	public interface OnScrollListener {

		/**
		 * The view is not scrolling. Note navigating the swipe_target using the
		...
		/**
		 * Callback method to be invoked while the swipe_target view or grid view is
		...
		/**
		 * Callback method to be invoked when the swipe_target or grid has been
		 ...
		 *            the number of items in the swipe_target adaptor
		 */
	 ...
	 * items. This however assumes that all swipe_target items have the same height. If
	 * you use a swipe_target in which items have different heights, the scrollbar will
	 * change appearance as the user scrolls through the swipe_target. To avoid this
	 ...
	 * scrollbar as the user navigates through a swipe_target of items with varying
	 * heights.
	 * 
	 * @param enabled
	...
	/**
	 * Set the listener that will receive notifications every time the swipe_target
	 * scrolls.
	 * 
	 * @param l
	 *            the scroll listener
	...
	/**
	 * When stack from bottom is set to true, the swipe_target fills its content
	...
	/**
	 * The swipe_target is empty. Clear everything out.
	 */
	void resetList() {
	 ...
	 * @see #getSelector()
	 * 
	 * @return The top swipe_target padding.
	 */
	 ...
	 * @see #getSelector()
	 * 
	 * @return The bottom swipe_target padding.
	 */
	 ...
	 * @see #getSelector()
	 * 
	 * @return The left swipe_target padding.
	 */
	 ...
	 * @see #getSelector()
	 * 
	 * @return The right swipe_target padding.
	 */
	 ...
	 * used to draw the selection in the swipe_target.
	 * 
	...
	/**
	 * Maps a point to a position in the swipe_target.
	 * 
	 * @param x
	...
	private class FlingRunnable implements Runnable {
		...
		public void run() {
			...
			case TOUCH_MODE_FLING: {
				...
				// Flip sign to convert finger direction to swipe_target items direction
				// (e.g. finger moving down means swipe_target is moving towards the
				// top)
	 ...
	 * @return true if we're already at the beginning/end of the swipe_target and have
	 *         nothing to do.
	 */
	@SuppressWarnings("deprecation")
	...
	/**
	 * Returns the number of header views in the swipe_target. Header views are special
	 * views at the top of the swipe_target that should not be recycled during a layout.
	 * 
	...
	/**
	 * Returns the number of footer views in the swipe_target. Footer views are special
	 * views at the bottom of the swipe_target that should not be recycled during a
	 * layout.
	 * 
	...
	/**
	 * Puts the swipe_target or grid into transcript mode. In this mode the swipe_target or grid
	 ...
	 * swipe_target is always drawn on top of a solid, single-color, opaque background
	 * 
	 * @param color
	 ...
	 * 
	 * @param views
	 *            A swipe_target into which to put the reclaimed views
	 */
	...
	public static class LayoutParams extends ViewGroup.LayoutParams {
		 ...
		 * already been added to the swipe_target view and whether they should be
	...
	class RecycleBin {
		...
		/**
		 * Put a view into the ScapViews swipe_target. These views are unordered.
		 * 
		 * @param scrap
		 *            The view to add
		 */
		...
		/**
		 * Puts all views in the scrap heap into the supplied swipe_target.
		 */
	...
	// ///////////////////////////////////////////////////
	// Check available space of swipe_target view.
	// ///////////////////////////////////////////////////
	...
	/**
	 * used in order to determine fill swipe_target more or not.
	 * 
	 * @return
	 */
