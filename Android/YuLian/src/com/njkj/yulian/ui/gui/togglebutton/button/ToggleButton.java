package com.njkj.yulian.ui.gui.togglebutton.button;
...
import com.njkj.yulian.ui.gui.togglebutton.SimpleSpringListener;
...
import com.njkj.yulian.ui.gui.togglebutton.SpringUtil;
...
public class ToggleButton extends View {
	...
	/** 开启颜色 */
	private int onColor = getResources().getColor(R.color.bluedc);
	/** 关闭颜色 */
	private int offBorderColor = getResources().getColor(
			R.color.off_border_color);
	/** 灰色带颜色 */
	private int offColor = getResources().getColor(R.color.white);
	/** 手柄颜色 */
	private int spotColor = getResources().getColor(R.color.white);
	/** 边框颜色 */
	...
	public void setup(AttributeSet attrs) {
		...
		isDefaultOn = typedArray.getBoolean(
				R.styleable.ToggleButton_isDefaultOn, isDefaultOn);
		typedArray.recycle();
