...
/**
 * A view that shows items in a vertically scrolling swipe_target. The items come from
...
public class PLA_ListView extends PLA_AbsListView {
     ...
     * times the height of the swipe_target.
     */
    private static final float MAX_SCROLL_FACTOR = 0.33f;

    /**
     * A class that represents a fixed view in a swipe_target, for example a header at
     * the top or a footer at the bottom.
     */
    public class FixedViewInfo {
        /** The view to add to the swipe_target */
        public View view;
        /**
         ...
         */
        public Object data;
        /** <code>true</code> if the fixed view should be selectable in the swipe_target */
    ...
    /**
     * @return The maximum amount a swipe_target view will scroll in response to an
     *         arrow event.
     */
    ...
    /**
     * Add a fixed view to appear at the top of the swipe_target. If addHeaderView is
    ...
    public void addHeaderView(View v, Object data, boolean isSelectable) {
        ...
        if (mAdapter != null) {
            throw new IllegalStateException("Cannot add header view to swipe_target -- setAdapter has already been called.");
        }
    ...
    /**
     * Add a fixed view to appear at the bottom of the swipe_target. If addFooterView is
     * called more than once, the views will appear in the order they were
     * added. Views added using this call can take focus if they want.
     * <p>
     * NOTE: Call this before calling setAdapter. This is so ListView can wrap
     ...
     *            backing this swipe_target and for producing a view to represent an
    ...
    /**
     * @return Whether the swipe_target needs to show the top fading edge
     */
    ...
    /**
     * @return Whether the swipe_target needs to show the bottom fading edge
     */
    ...
    /**
     * override this method to manipulate the position of each item in swipe_target
    ...
    /**
     * Fills the swipe_target from pos down to the end of the swipe_target view.
     * 
     * @param pos
     *            The first position to put in the swipe_target
     * 
     * @param nextTop
    ...
    /**
     * Fills the swipe_target from pos up to the top of the swipe_target view.
     * 
     * @param pos
     *            The first position to put in the swipe_target
     * 
    ...
    /**
     * Fills the swipe_target from top to bottom, starting with mFirstPosition
     * 
     * @param nextTop
     ...
     * @hide
     */
    @ViewDebug.ExportedProperty(category = "swipe_target")
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition, final int maxHeight,
        ...
        // Include the padding of the swipe_target
    ...
    private View fillSpecific(int position, int top) {
        ...
        if (!mStackFromBottom) {
            ...
            // the bottom of the swipe_target
            adjustViewsUpOrDown();
            fillUp(position - 1, temp.getTop());
            int childCount = getChildCount();
            if (childCount > 0) {
    ...
    /**
     * Check if we have dragged the bottom of the swipe_target too high (we have pushed
    ...
    private void correctTooHigh(int childCount) {
        ...
        // top of the swipe_target to be pushed up.
    ...
    /**
     * Check if we have dragged the bottom of the swipe_target too low (we have pushed
    ...
    private void correctTooLow(int childCount) {
        ...
        // the
        // bottom of the swipe_target to be pushed down.
    ...
    /**
     * @param child
     *            a direct child of this swipe_target.
    ...
    /**
     * Obtain the view and add it to our swipe_target of children. The view can be made
     * fresh, converted from an unused view, or used as is if it was in the
     * recycle bin.
     * 
     * @param position
     *            Logical position in the swipe_target
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            // may have brought in the last child of the swipe_target that is skinnier
            ...
            // may have brought the very first child of the swipe_target in too far and
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (drawOverscrollHeader || drawOverscrollFooter) {
            ...
            final ListAdapter adapter = mAdapter;
            // If the swipe_target is opaque *and* the background is not, we want to
            // fill a rect where the dividers would be for non-selectable items
            // If the swipe_target is opaque and the background is also opaque, we don't
    ...
    /**
     * Sets the drawable that will be drawn above all other swipe_target content. This
     * area can become visible when the user overscrolls the swipe_target.
     * 
     * @param header
     *            The drawable to use
     */
    ...
    /**
     * @return The drawable that will be drawn above all other swipe_target content
     */
    ...
    /**
     * Sets the drawable that will be drawn below all other swipe_target content. This
     * area can become visible when the user overscrolls the swipe_target, or when the
     * swipe_target's content does not fully fill the container area.
     * 
     * @param footer
     *            The drawable to use
     */
    ...
    /**
     * @return The drawable that will be drawn below all other swipe_target content
     */
     ...
     * parsed them move them out of the children swipe_target and into mHeaderViews.
     */
    @Override
    ...
    /**
     * Returns the set of checked items in the swipe_target. The result is only valid if
     * the choice mode has not been set to {@link #CHOICE_MODE_NONE}.
     * 
     * @return A SparseBooleanArray which will return true for each call to
     *         get(int position) where position is a position in the swipe_target, or
