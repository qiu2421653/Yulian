...
//    	mTouchMode = newState;
    ...
    /**
     * Scroll the swipe_target so the first visible position in the grid is the first
     * item in the adapter.
     */
    ...
    public interface OnScrollListener {
        ...
        /**
         * The view is not scrolling. Note navigating the swipe_target using the trackball counts as
        ...
        /**
         * Callback method to be invoked while the swipe_target view or grid view is being scrolled. If the
        ...
        /**
         * Callback method to be invoked when the swipe_target or grid has been scrolled. This will be
         * called after the scroll has completed
         * @param view The view whose scroll state is being reported
         * @param firstVisibleItem the index of the first visible cell (ignore if
         *        visibleItemCount == 0)
         * @param visibleItemCount the number of visible cells
         * @param totalItemCount the number of items in the swipe_target adaptor
         */
