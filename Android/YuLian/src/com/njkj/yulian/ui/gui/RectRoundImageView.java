...
public class RectRoundImageView extends ImageView {
	...
	public RectRoundImageView(Context context, AttributeSet attrs) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.RectRoundImageView);

		mBorderRadius = a.getDimensionPixelSize(
				R.styleable.RectRoundImageView_borderRadius, (int) TypedValue
						.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
								BODER_RADIUS_DEFAULT, getResources()
										.getDisplayMetrics()));// 默认为10dp
		type = a.getInt(R.styleable.RectRoundImageView_type, TYPE_CIRCLE);// 默认为Circle
