...
public abstract class PLA_AdapterView<T extends Adapter> extends ViewGroup {
    ...
    public interface OnItemLongClickListener {
         ...
         * @param position
         *            The position of the view in the swipe_target
         * @param id
         *            The row id of the item that was clicked
         * 
     ...
     *         swipe_target item (or it is not currently visible).
     */
    public int getPositionForView(View view) {
        ...
        try {
            ...
            // We made it up to the window without find this swipe_target view
            return INVALID_POSITION;
        }

        // Search the children for the swipe_target item
    ...
    /**
     * Update the status of the swipe_target based on the empty parameter. If empty is
     ...
     * it's not null).
     */
    @SuppressLint("WrongCall") private void updateEmptyStatus(boolean empty) {
        if (isInFilterMode()) {
            empty = false;
        }
        ...
        if (empty) {
            if (mEmptyView != null) {
                ...
                // If the caller just removed our empty view, make sure the swipe_target
                // view is visible
                setVisibility(View.VISIBLE);
            }

            // We are now GONE, so pending layouts will not be dispatched.
            // Force one here to make sure that the state of the swipe_target matches
    ...
    /**
     * Gets the data associated with the specified position in the swipe_target.
     * 
     * @param position
     *            Which data to get
     * @return The data associated with the specified position in the swipe_target
     */
