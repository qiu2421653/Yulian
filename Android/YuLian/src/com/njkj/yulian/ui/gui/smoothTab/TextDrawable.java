...
/**
 * A Drawable object that draws text.绘制文本的可绘制对象 A TextDrawable accepts most of
 * the same parameters that can be applied to {@link android.widget.TextView}
 * for displaying and formatting text. TextDrawable接受了大部分跟TextView中一样的的参数
 * 用来显示和规范文字 Optionally, a {@link Path} may be supplied on which to draw the
 * text. 还可以选择把文字按路径来画
 * 
...
public class TextDrawable extends Drawable {
    ...
    /* Stateful text color swipe_target *///有状态的文本颜色列表
    ...
    /**
     * Set the text color as a state swipe_target
    ...
    public boolean isStateful() {
         ...
         * the text color swipe_target set
         */
