...
package com.njkj.yulian.ui.gui.wheel;
...
public class WheelRecycle {
	...
	/**
	 * Adds view to specified cache. Creates a cache swipe_target if it is null.
	 * @param view the view to be cached
	 * @param cache the cache swipe_target
	 * @return the cache swipe_target
	 */
