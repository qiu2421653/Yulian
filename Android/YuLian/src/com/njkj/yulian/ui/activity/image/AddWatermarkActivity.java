...
public class AddWatermarkActivity extends Activity implements OnClickListener {
	...
	private TextView chunvzuo, shenhuifu, qiugouda, guaishushu, haoxingzuo,
			wanhuaile, xiangsi, xingzuokong, xinnian, zaoan, zuile, jiuyaozuo,
			zui;
	...
	private void fillContent() {
		Bitmap resizeBmp = BitmapFactory.decodeFile(filePath);
	...
	private void btnSave() {
		...
		if (bmp != null) {
			filePath = saveBitmap(bmp, "saveTemp");
			Intent okData = new Intent();
			okData.putExtra("filePath", filePath);
