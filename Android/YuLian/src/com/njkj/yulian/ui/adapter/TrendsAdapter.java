...
public class TrendsAdapter extends BaseAdapter {
	...
	private ArrayList<MallEntity> mUserList;
	private LayoutInflater mInflater;
	private Context mContext;

	public TrendsAdapter(ArrayList<MallEntity> mUserList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tv_item.setText(mUserList.get(position).getName()
				.toUpperCase());
		return convertView;
	}
	...
	class ViewHolder {
		...
		public ViewHolder(View view) {
			...
			tv_item.setTypeface(TypefacesUtils.get(mContext, "Satisfy-Regular.ttf"));
		}
	}
