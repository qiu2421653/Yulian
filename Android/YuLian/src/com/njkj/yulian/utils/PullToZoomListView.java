...
public class PullToZoomListView extends ListView implements
    ...
    private void init(Context paramContext) {
        ...
        this.mHeaderRelativeLayout = new RelativeLayout(paramContext);
        ...
        this.mHeaderContainer.addView(this.mHeaderRelativeLayout);
        this.mHeaderRelativeLayout.addView(mHeaderImage);
    ...
    public RelativeLayout getHeaderRView() {
