 ...
 */
@RestController
public class FsSearchContentController {
    private static final Logger logger = LoggerFactory.getLogger(FsSearchContentController.class);
     ...
     * 
     */
    @RequestMapping(value = "FsSearchContent", method = RequestMethod.POST)
    public @ResponseBody JsonResponse fsSearchTag(@RequestBody FsSearchContentParameter vo) {
        ...
        List<FsSearchContentDTOVo> fsGetTopicList = fsSearchContentService
                .getFsGetContentListVoList(vo.getUserID(), vo.getContent());
