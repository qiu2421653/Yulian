 ...
 */
@RestController
public class FsSearchTagController {
    private static final Logger logger = LoggerFactory.getLogger(FsSearchTagController.class);
     ...
     * 
     */
    @RequestMapping(value = "FsSearchTag", method = RequestMethod.POST)
    public @ResponseBody JsonResponse fsSearchTag(@RequestBody FsSearchTagParameter vo) {
        ...
        List<FsSearchTagDTOVo> fsGetTopicList = fsSearchTagService
                .getFsGetTagListVoList(vo.getUserID(), vo.getTag());
