...
public final class DesEncryptUtil {
	...
	/** 字符串默认键值     */
	private static String strDefaultKey = "naga";
	...
	public static byte[] hexStr2ByteArr(String strIn) {
		try {
			...
			throw new MySystemException(ex,"msg.common.10010");
		}
	}
...
//		try {
			String test = "x8M_K3p_qv";
			DesEncryptUtil des = new DesEncryptUtil(strDefaultKey);//自定义密钥
